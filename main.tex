\documentclass[highlight, explanations]{prereg}
...
\question{Study design (required)}
...
\question{Existing data (required)}
...
\question{Explanation of existing data (optional)}
...
\question{Data collection procedures (required)}
...
\question{Sample size rationale (optional)}
...
\question{Stopping rule (optional)}
{
...
\question{Manipulated variables (optional)}
...
\question{Measured variables (required)}
...
\question{Statistical models (required)}
...
\question{Transformations (optional)}
...
\question{Inference criteria (optional)}
...
\question{Data exclusion (optional)}
...
\question{Missing data (optional)}
...
\question{Exploratory analysis (optional)}
